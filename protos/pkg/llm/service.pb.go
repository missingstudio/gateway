...
var file_llm_service_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x2a, 0x39, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x52, 0x65, 0x61,
	...
	0x50, 0x10, 0x02, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x32, 0xda,
	0x02, 0x0a, 0x0a, 0x4c, 0x4c, 0x4d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x74, 0x0a,
	...
	0x6f, 0x6e, 0x73, 0x12, 0x50, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	0x73, 0x12, 0x14, 0x2e, 0x6c, 0x6c, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x6c, 0x6c, 0x6d, 0x2e, 0x76, 0x31,
	0x2e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x15,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0f, 0x3a, 0x01, 0x2a, 0x12, 0x0a, 0x2f, 0x76, 0x31, 0x2f, 0x6d,
	0x6f, 0x64, 0x65, 0x6c, 0x73, 0x12, 0x83, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72,
	...
	0x6e, 0x73, 0x3a, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x30, 0x01, 0x42, 0x89, 0x01, 0x0a, 0x0a,
	0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x6c, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x73, 0x74,
	0x75, 0x64, 0x69, 0x6f, 0x2f, 0x73, 0x74, 0x75, 0x64, 0x69, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x6c, 0x6c, 0x6d, 0x3b, 0x6c, 0x6c, 0x6d, 0x76, 0x31,
...
var file_llm_service_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_llm_service_proto_goTypes = []interface{}{
	...
	nil,                            // 12: llm.v1.ModelResponse.ModelsEntry
	(*structpb.Struct)(nil),        // 13: google.protobuf.Struct
}
var file_llm_service_proto_depIdxs = []int32{
	13, // 0: llm.v1.ChatCompletionMessage.logprobs:type_name -> google.protobuf.Struct
	3,  // 1: llm.v1.ChatCompletionRequest.messages:type_name -> llm.v1.ChatCompletionMessage
	13, // 2: llm.v1.ChatCompletionRequest.logit_bias:type_name -> google.protobuf.Struct
	2,  // 3: llm.v1.ChatCompletionRequest.response_format:type_name -> llm.v1.ResponseFormat
	13, // 4: llm.v1.ChatCompletionRequest.tool_choice:type_name -> google.protobuf.Struct
	3,  // 5: llm.v1.CompletionChoice.message:type_name -> llm.v1.ChatCompletionMessage
	13, // 6: llm.v1.CompletionChoice.logprobs:type_name -> google.protobuf.Struct
	...
	12, // 9: llm.v1.ModelResponse.models:type_name -> llm.v1.ModelResponse.ModelsEntry
	11, // 10: llm.v1.ProviderModels.models:type_name -> llm.v1.Model
	10, // 11: llm.v1.ModelResponse.ModelsEntry.value:type_name -> llm.v1.ProviderModels
	4,  // 12: llm.v1.LLMService.GetChatCompletions:input_type -> llm.v1.ChatCompletionRequest
	8,  // 13: llm.v1.LLMService.ListModels:input_type -> llm.v1.ModelRequest
	4,  // 14: llm.v1.LLMService.GetStreamChatCompletions:input_type -> llm.v1.ChatCompletionRequest
	7,  // 15: llm.v1.LLMService.GetChatCompletions:output_type -> llm.v1.ChatCompletionResponse
	9,  // 16: llm.v1.LLMService.ListModels:output_type -> llm.v1.ModelResponse
	7,  // 17: llm.v1.LLMService.GetStreamChatCompletions:output_type -> llm.v1.ChatCompletionResponse
