...
var file_llm_service_proto_rawDesc = []byte{
	...
	0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x2a,
	0x39, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12,
	0x08, 0x0a, 0x04, 0x4e, 0x55, 0x4c, 0x4c, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x4c, 0x45, 0x4e,
	0x47, 0x54, 0x48, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x54, 0x4f, 0x50, 0x10, 0x02, 0x12,
	0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x32, 0xb9, 0x03, 0x0a, 0x0a, 0x4c,
	0x4c, 0x4d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x74, 0x0a, 0x12, 0x47, 0x65, 0x74,
	...
	0x83, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x68, 0x61,
	...
	0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x12, 0x5d, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x54,
...
var file_llm_service_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_llm_service_proto_goTypes = []interface{}{
	...
	nil,                            // 13: llm.v1.ModelResponse.ModelsEntry
	(*structpb.Struct)(nil),        // 14: google.protobuf.Struct
	(*emptypb.Empty)(nil),          // 15: google.protobuf.Empty
}
var file_llm_service_proto_depIdxs = []int32{
	14, // 0: llm.v1.ChatCompletionMessage.logprobs:type_name -> google.protobuf.Struct
	3,  // 1: llm.v1.ChatCompletionRequest.messages:type_name -> llm.v1.ChatCompletionMessage
	14, // 2: llm.v1.ChatCompletionRequest.logit_bias:type_name -> google.protobuf.Struct
	2,  // 3: llm.v1.ChatCompletionRequest.response_format:type_name -> llm.v1.ResponseFormat
	14, // 4: llm.v1.ChatCompletionRequest.tool_choice:type_name -> google.protobuf.Struct
	3,  // 5: llm.v1.CompletionChoice.message:type_name -> llm.v1.ChatCompletionMessage
	14, // 6: llm.v1.CompletionChoice.logprobs:type_name -> google.protobuf.Struct
	...
	13, // 9: llm.v1.ModelResponse.models:type_name -> llm.v1.ModelResponse.ModelsEntry
	11, // 10: llm.v1.ProviderModels.models:type_name -> llm.v1.Model
	14, // 11: llm.v1.LogResponse.logs:type_name -> google.protobuf.Struct
	10, // 12: llm.v1.ModelResponse.ModelsEntry.value:type_name -> llm.v1.ProviderModels
	4,  // 13: llm.v1.LLMService.GetChatCompletions:input_type -> llm.v1.ChatCompletionRequest
	4,  // 14: llm.v1.LLMService.GetStreamChatCompletions:input_type -> llm.v1.ChatCompletionRequest
	8,  // 15: llm.v1.LLMService.ListModels:input_type -> llm.v1.ModelRequest
	15, // 16: llm.v1.LLMService.ListTrackingLogs:input_type -> google.protobuf.Empty
	7,  // 17: llm.v1.LLMService.GetChatCompletions:output_type -> llm.v1.ChatCompletionResponse
	7,  // 18: llm.v1.LLMService.GetStreamChatCompletions:output_type -> llm.v1.ChatCompletionResponse
	9,  // 19: llm.v1.LLMService.ListModels:output_type -> llm.v1.ModelResponse
	12, // 20: llm.v1.LLMService.ListTrackingLogs:output_type -> llm.v1.LogResponse
