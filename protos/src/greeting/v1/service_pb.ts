...
/**
 * @generated from message greeting.v1.GreetRequest
 */
export class GreetRequest extends Message<GreetRequest> {
  ...
  static readonly typeName = "greeting.v1.GreetRequest";
...
/**
 * @generated from message greeting.v1.GreetResponse
 */
export class GreetResponse extends Message<GreetResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "greeting.v1.GreetResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
