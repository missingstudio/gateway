          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12s">
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <h4 className="font-medium text-slate-50">Usage monitoring</h4>
              </div>
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Cost analytics</h4>
              </div>
              <p className="text-sm text-slate-400">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">LLM optimization</h4>
              </div>
              <p className="text-sm text-slate-400">
